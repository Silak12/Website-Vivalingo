...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    { 
      ...
      url: 'https://twitter.com/VivaLaLingo',
    },
    { 
      name: 'Instagram', 
      icon: (
      ...
      url: 'https://instagram.com/VivaLaLingo',
    },
    { 
      name: 'TikTok', 
      icon: (
      ...
      url: 'https://tiktok.com/@VivaLaLingo',
    },
    { 
      name: 'Facebook', 
      icon: (
      ...
      url: 'https://facebook.com/VivaLaLingo',
    },
  ];
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            >
              <Link to="/" className="flex items-center">
                ...
                <img src={`${import.meta.env.BASE_URL}images/logo2.png`} alt="VivaLaLingo Logo" className="h-12 w-12 mr-2" />
                <span className="text-xl font-bold">VivaLaLingo</span>
              </Link>
