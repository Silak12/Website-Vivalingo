...
const Footer: React.FC = () => {
  ...
  const footerSections = [
    ...
    },
    {
      title: 'Legal',
      links: [
        { name: 'Privacy Policy', path: '/datenschutz' },
        { name: 'Terms of Service', path: '/agb' },
    ...
    <footer className="bg-gray-900 text-white">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            >
              <Link to="/" className="flex items-center">
                <img src="/images/logo.svg" alt="Vivalingo Logo" className="h-8 w-8 mr-2" />
                <span className="text-xl font-bold">Vivalingo</span>
              </Link>
              <p className="text-gray-400 mt-2 max-w-xs">
                Learn languages naturally with the Birkenbihl method. No grammar rules, just intuitive learning.
              </p>
            </motion.div>
      ...
      <div className="bg-gray-950 py-4">
        <div className="container-custom flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          <div>
            &copy; {new Date().getFullYear()} Vivalingo. All rights reserved.
          </div>
