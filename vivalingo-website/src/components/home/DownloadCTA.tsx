            ...
            >
              ...
              >
                <Button 
                  variant="primary" 
                  size="lg"
                  className="min-w-40 flex items-center justify-center gap-2 shadow-lg shadow-primary-500/30 hover:scale-105 transition-transform"
                >
              ...
              <Button 
                variant="secondary" 
                size="lg"
                className="min-w-40 flex items-center justify-center gap-2 shadow-lg shadow-secondary-500/30 opacity-60 cursor-not-allowed"
                disabled
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
