...
const About: React.FC = () => {
  ...
  const socialLinks = [
    { 
      ...
      url: 'https://twitter.com/vivalingo',
    },
    { 
      name: 'Instagram', 
      icon: (
    ...
    { 
      ...
      url: 'https://facebook.com/vivalingo',
    },
  ];
    ...
    <div ref={pageRef} className="relative min-h-screen py-20">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 max-w-3xl">
        ...
        >
          <div className="prose prose-lg prose-invert max-w-none">
            <p className="text-gray-300 mb-6">
              Hey there! I'm the creator of Vivalingo. This app started as a personal project — I simply wanted a better way to learn languages for myself using the Birkenbihl method.
            </p>
            ...
            <p className="text-gray-300 mb-6">
              I figured, if my close circle found it useful, maybe others would too. So here we are! I've released Vivalingo to the world in hopes that others can benefit from this powerful language learning method just like I have.
            </p>
            ...
            <p className="text-gray-300">
              I'm completely open to feedback and suggestions. So if you have ideas about how to make Vivalingo better, I'm all ears!
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          {/* Email address */}
          <a 
            href="mailto:vivalingoapp@gmail.com" 
          ...
          >
            <div className="flex items-center justify-center">
              ...
              <span>vivalingoapp@gmail.com</span>
            </div>
          </a>
